...
административных черновиков, а также поручения и серии поручений реализованы
через server API.
...
| 5. Business API | В работе | Пользователи, профиль, справочники, настройки, документы и поручения перенесены; следующий срез — ознакомления и связанные read-модели |
...
Следующий рекомендуемый срез — ознакомления, user events, связи, journal,
dashboard и statistics.

После него рекомендуемый порядок:

1. Ознакомления, user events, связи, journal, dashboard и statistics.
