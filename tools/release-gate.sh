...
run_step "docs-links-check" "Documentation links" make --no-print-directory docs-links-check
run_step "go-test" "Go tests" make --no-print-directory go-test
run_step "integration-test" "PostgreSQL/S3 integration" make --no-print-directory integration-test
