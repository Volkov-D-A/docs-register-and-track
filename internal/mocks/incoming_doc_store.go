...
// Create provides a mock function with given fields: nomenclatureID, documentTypeID, senderOrgID, recipientOrgID, createdBy, incomingNumber, incomingDate, outgoingNumberSender, outgoingDateSender, intermediateNumber, intermediateDate, subject, content, pagesCount, senderSignatory, senderExecutor, addressee, resolution
...
// Update provides a mock function with given fields: id, documentTypeID, senderOrgID, recipientOrgID, outgoingNumberSender, outgoingDateSender, intermediateNumber, intermediateDate, subject, content, pagesCount, senderSignatory, senderExecutor, addressee, resolution
