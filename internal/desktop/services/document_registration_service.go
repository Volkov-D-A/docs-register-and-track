...
func NewDocumentRegistrationService(client DocumentCommandClient, lifecycle *operations.Lifecycle) *DocumentRegistrationService {
	return &DocumentRegistrationService{client: client, lifecycle: lifecycle}
}
