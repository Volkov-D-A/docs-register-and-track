...
Remaining target OS validation belongs to the maintained frontend/e2e smoke checklist after `ISSUE-043`; broader table/list empty states can be revisited with the table component test pass.

Связанные issues: fixed `ISSUE-047`, `ISSUE-043`.
