...
No e2e framework/config was found. There is no automated production build smoke for Wails desktop lifecycle.
...
Связанные issues: `ISSUE-038`, `ISSUE-039`, `ISSUE-041`.
