...
export function Create(arg1:string,arg2:string,arg3:Array<string>):Promise<dto.Acknowledgment>;
...
export function SetSubstitutionStore(arg1:ports.UserSubstitutionStore):Promise<void>;
